	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-home"></i> 主页 <span>Subtitle goes here...</span>
				</h2>
			</div>
					...
					<div class="col-md-12">
					  <h3>
						...
						<c:if test="${page.hasPrev }">
							<a class="btn btn-darkblue" href="drops.do?method=searchDrops&keyword=${param.keyword }">首页</a>
							<a class="btn btn-primary" href="drops.do?method=searchDrops&keyword=${param.keyword }&pageNo=${page.prevPage }">上一页</a>
						</c:if>
						<c:if test="${page.hasNext }">
							<a class="btn btn-darkblue" href="drops.do?method=searchDrops&keyword=${param.keyword }&pageNo=${page.nextPage }">下一页</a>
							<a class="btn btn-primary" href="drops.do?method=searchDrops&keyword=${param.keyword }&pageNo=${page.totalPageNumber }">末页</a>
						</c:if>
					  </h3>
 						<h3>
