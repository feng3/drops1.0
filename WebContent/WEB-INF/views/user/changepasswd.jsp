	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-user"></i> 用户中心 <span>修改密码</span>
				</h2>
			</div>
			...
			<div class="contentpanel">
				...
				<div class="panel panel-default">
			        ...
			        <div class="panel-body">
			          <form class="form-inline" action="./user.do?method=doChangePasswd" method="post">
			          	<p class="mt5 mb20">
							<span style="color: Red">${message }</span>
						</p>
			          	原密码：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			            <div class="form-group">
			              <input name="originpwd" type="password" id="exampleInputEmail2" class="form-control" required/>
			            </div>
			            <br>
			            <br>
			          	新密码：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			            <div class="form-group">
			              <input name="pwd1" type="password" id="exampleInputEmail2" class="form-control" required/>
			            </div>
			            <br>
			            <br>
			          	重复新密码：
			            <div class="form-group">
			              <input name="pwd2" type="password" id="exampleInputEmail2" class="form-control" required/>
			            </div>
			            <br>
			            <br>
